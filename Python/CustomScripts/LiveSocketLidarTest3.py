...
if __name__ == "__main__":
    ...
    sensorprofile_path1 = "EgoVehicleSettings\DemoAllSensors.SensorProfile.ini"
    sensor_path_in_file1 = "Sensors.Sensors.[0]"
    overrides = "{file_path};{sensor_path}.StreamToNetwork;True".format(file_path=sensorprofile_path1, sensor_path=sensor_path_in_file1)
