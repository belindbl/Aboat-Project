...
###############################################################################
# This script loads the OpenOcean level with Harbour scene and a Situation with boats 
###############################################################################
...
def LaunchDemo():
	...
	TestContext.client.request_load_sub_scene('Coast_Skyscrapers', True)
	TestContext.client.request_load_situation('OpenOceanRandomBoatsAtHarbour')
